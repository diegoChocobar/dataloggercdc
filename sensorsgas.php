          ...
          <div class="row">
            ...
            ?>
              <?php for($i=0;$i<$devices_num;$i++){ ?>
                <?php if($devices[$i]['tipo'] == "Sensor Gas" ){ ?>
                        <div class="col-xs-12 col-sm-4">
                          <div class="box p-a">
                            ...
                            <div class="clear">
                              <h4 class="m-0 text-lg _300"><b id="gas_<?php echo $devices[$i]['nombre'] ?>">--</b><span class="text-sm"> ppm</span></h4>
                              <small class="text-muted">Gas <?php echo $devices[$i]['nombre'] ?></small>
                            </div>
                          </div>
                        </div>
                <?php } ?>
      ...
      if(tamaño_topic == 5){//recibimos un mensaje con longitud/caracteristica valida
        ...
        <?php foreach ($devices as $device ) { ?>
          if(topic == '<?php echo $device['mqtt']; ?>'){
            ...
            if(tipo_topic == "Sensor Gas"){
                value_gas_mqtt = message.toString();
                $("#gas_"+alias_topic).html(value_gas_mqtt);
            }
