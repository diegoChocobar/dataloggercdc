          ...
          <div class="row">
            ...
            ?>
              <?php for($i=0;$i<$devices_num;$i++){ ?>
                <?php if($devices[$i]['tipo'] == "Sensor Humedad" ){ ?>
                        <div class="col-xs-12 col-sm-4">
                          <div class="box p-a">
                            ...
                            <div class="clear">
                              <h4 class="m-0 text-lg _300"><b id="humedad_<?php echo $devices[$i]['nombre'] ?>">--</b><span class="text-sm"> %</span></h4>
                              <small class="text-muted">Humedad <?php echo $devices[$i]['nombre'] ?></small>
                            </div>
                          </div>
                        </div>
                <?php } ?>
      ...
      if(tamaño_topic == 5){//recibimos un mensaje con longitud/caracteristica valida
        ...
        <?php foreach ($devices as $device ) { ?>
          if(topic == '<?php echo $device['mqtt']; ?>'){
            ...
            if(tipo_topic == "Sensor Humedad"){
                value_humedad_mqtt = message.toString();
                $("#humedad_"+alias_topic).html(value_humedad_mqtt);
            }
